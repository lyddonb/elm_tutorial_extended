...
-- TODO: Make pop up form 
--         http://package.elm-lang.org/packages/etaque/elm-dialog/1.1.0/
-- TODO: Switch to proper form and submit form button
-- TODO: Add validation
-- TODO: Add message for save complete
...
submitButton : Signal.Address Action -> ViewModel -> Html.Html
submitButton address model =
  button
    [class "btn regular btn-primary"
    , onClick address (SubmitForm model.player.id)
    ]
    [text "Submit"]
